...
#reseau de neurone 
# premiere couche 5 entrées
#2 couche cachées  de deux noeud chacune avec un noeud de polarisation pour chaque couche caché
#une couche de sortie avec un noeud de polarisation
#prix de la cabine test ?
...
def hidden_activation(z):
    ...
    #retourne le plus grand entre 0 et z
